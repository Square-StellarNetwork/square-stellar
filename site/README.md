...
The front door: what the protocol is, what it is built on, how it is used, and the door to the app (`NEXT_PUBLIC_APP_URL`). A static Next.js export with no runtime data; the app is where the chain is read.
