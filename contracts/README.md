...
[#27](https://github.com/Square-StellarNetwork/square/issues/27). A proof that verifies but
...
[#119](https://github.com/Square-StellarNetwork/square/issues/119) added two range checks to
...
`npm run build`. [#16](https://github.com/Square-StellarNetwork/square/issues/16) fixes one
...
[#159](https://github.com/Square-StellarNetwork/square/issues/159); both paid an effective
...
existed. Read from the chain for [#159](https://github.com/Square-StellarNetwork/square/issues/159):
...
[#28](https://github.com/Square-StellarNetwork/square/issues/28).
...
The script needs `circuits/`'s dependencies installed (`npm ci` there), which
building the key already requires.
