...
[i108]: https://github.com/Square-StellarNetwork/square/issues/108
[i77]: https://github.com/Square-StellarNetwork/square/pull/77
[i97]: https://github.com/Square-StellarNetwork/square/pull/97
[i100]: https://github.com/Square-StellarNetwork/square/issues/100
[i78]: https://github.com/Square-StellarNetwork/square/pull/78
...
Each of the two directories names two owners: the person who writes most of it,
and a second owner shared by both lines.

One person writes the contracts, another the circuits, and neither can approve
their own pull request, so a rule naming one owner per directory would make that
...
until the second owner has read it. It is the cost the issue asked to weigh, and
