...
**The prover is not where an institution proves** ([#347](https://github.com/Square-StellarNetwork/square/issues/347),
...
Decided on 2026-09-15 ([#336](https://github.com/Square-StellarNetwork/square/issues/336)),
...
`compose.yaml` ([#370](https://github.com/Square-StellarNetwork/square/issues/370)); the
shared stack installs screening ([#372](https://github.com/Square-StellarNetwork/square/issues/372),
...
[#336](https://github.com/Square-StellarNetwork/square/issues/336) when the services are
