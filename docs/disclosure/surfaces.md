...
[i3]: https://github.com/Square-StellarNetwork/square/issues/3
[i262]: https://github.com/Square-StellarNetwork/square/issues/262
...
2. The `secret scan` job failed with `[<organisation>] is an organization. License
...
```bash
# in a clean checkout of aperture
cd aperture
...
[i5]: https://github.com/Square-StellarNetwork/square/issues/5
...
> applies.
> Verify: `github.com/Square-StellarNetwork/square` → `docs/disclosure/zk-setup-status.md`
