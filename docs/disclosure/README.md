...
aperture is a demo in **both** phases
— a locally generated powers of tau, and a phase 2 with one contribution and no
beacon. Tracked as [#3](https://github.com/Square-StellarNetwork/square/issues/3), lifted
by [#16](https://github.com/Square-StellarNetwork/square/issues/16).
...
| [patches/](./patches/) | Unified diffs against aperture, verified to apply cleanly. |
...
```bash
# with a checkout of aperture at ../aperture
