...
[i324]: https://github.com/Square-StellarNetwork/square/issues/324
[i336]: https://github.com/Square-StellarNetwork/square/issues/336
[i347]: https://github.com/Square-StellarNetwork/square/issues/347
[i353]: https://github.com/Square-StellarNetwork/square/issues/353
[i370]: https://github.com/Square-StellarNetwork/square/issues/370
...
| `square-indexer` | `ghcr.io/square-stellarnetwork/square-indexer:main` | 3010 | `/status`, `/jobs/finalizable`, `/actions`, the app's inbox; feeds the keeper |
| `square-keeper` | `ghcr.io/square-stellarnetwork/square-keeper:main` | 3011 | finalizes every job whose window closed; `/actions` is its journal |
| `square-screener` | `ghcr.io/square-stellarnetwork/square-screener:main` | 3012 | screens funding and release parties against TRM; the keeper asks it before a release ([#370][i370]) |
| `square-prover` | `ghcr.io/square-stellarnetwork/square-prover:main` | 3003 | the app's job page only ([#347][i347]); its artifacts are [#353][i353]'s, below |
| `square-hosted` | `ghcr.io/square-stellarnetwork/square-hosted:main` | 3000 | the hosted agent of [#336][i336]'s addendum: an agent registered on Arc, its card resolvable, taking work through `square_hire` and delivering it |
...
- `ghcr.io/square-stellarnetwork/square-<name>:sha-<12 hex>`: the record, written once;
- `ghcr.io/square-stellarnetwork/square-<name>:main`: what `main` built last.
...
anonymous `GET /v2/square-stellarnetwork/<package>/manifests/main` at `ghcr.io` answers
...
1. New service, **Docker image**, `ghcr.io/square-stellarnetwork/square-<name>:main`.
...
| `PORT` | `3010` | |
| `CORS_ORIGINS` | the app's origin, `https://square-app.example` | the app's inbox reads `/jobs/provider/<address>` from the browser |
