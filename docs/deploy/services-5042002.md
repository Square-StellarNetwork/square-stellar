...
> [#104](https://github.com/Square-StellarNetwork/square/issues/104) named as a defect and
> [#147](https://github.com/Square-StellarNetwork/square/pull/147) fixed, and they showed
...
(cd services/indexer && START_BLOCK=<deployment block> PORT=3010 CORS_ORIGINS=https://square-app.example node dist/main.js &)
...
curl -H "Origin: https://square-app.example" -i -s localhost:3010/status
```
...
```
HTTP/1.1 200 OK
access-control-allow-origin: https://square-app.example
vary: Origin
