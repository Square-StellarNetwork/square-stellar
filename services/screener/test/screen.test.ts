...
describe("a browser calling the screener", () => {
  const APP = "https://square-app.example";
  ...
  it("writes no Access-Control-Allow-Origin for an origin it does not name", async () => {
    for (const origin of ["https://evil.example", "https://square-app.example.evil.example", "http://localhost.evil.example:3000", "https://localhost:3000"]) {
